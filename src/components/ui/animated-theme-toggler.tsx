...
export const AnimatedThemeToggler = ({
  ...
  return (
    ...
    >
      {isDark ? (
        <Moon className="text-white h-5 w-h-5  rotate-90 transition-all scale-0 dark:scale-100 dark:rotate-0" />
      ) : (
        <Sun className=" rotate-0 h-5 w-h-5   transition-all scale-100 dark:scale-0 dark:-rotate-90" />
      )}
