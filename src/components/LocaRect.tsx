...
const LocaRect = ({ listing, children }: Props) => {
  return (
    <div className="flex flex-col lg:flex-row gap-4 shadow-[0_3px_10px_rgb(0,0,0,0.2)] dark:shadow-[0_2px_10px_rgba(255,255,255,0.03)] rounded border p-4 mb-4 hover:shadow-md transition-shadow">
      {listing.photos[0] ? (
        <Image
